...
let loader = <HTMLElement>document.getElementById("preloaderdefou");
const cursorRounded = <HTMLElement>document.querySelector(".rounded");
let menuItem = <HTMLElement>document.querySelector(".menu");
const likes = [
  "True detective",
  "Museums",
  "UI Design",
...
window.addEventListener("scroll", () => {
  if (window.offsetHeight + window.scrollTop >= window.scrollHeight) {
    window.console.log("scrolled to bottom");
  }
});
function scrollText() {
